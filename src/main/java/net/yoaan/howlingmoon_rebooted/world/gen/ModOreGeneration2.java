...
public class ModOreGeneration2 {
    public static void generateOres(final BiomeLoadingEvent event) {
        spawnOreInAllBiomes(OreType.SILVER_ORE, event, LevelStem.OVERWORLD.toString());
        spawnOreInAllBiomes(OreType.DEEPSLATE_SILVER_ORE, event, LevelStem.OVERWORLD.toString());

    }

    private static OreConfiguration getOverworldFeatureConfig(OreType ore) {
        return new OreConfiguration(OreFeatures.DEEPSLATE_ORE_REPLACEABLES,
